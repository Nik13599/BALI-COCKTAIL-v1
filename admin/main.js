...
function createWindow(){
  ...
  win.webContents.on('did-finish-load',async()=>{for(const name of ['v13-core.js','products.js','print-tools.js','publish-fix.js']){try{const code=fs.readFileSync(path.join(__dirname,name),'utf8');await win.webContents.executeJavaScript(code)}catch(e){console.error(name,e)}}});
