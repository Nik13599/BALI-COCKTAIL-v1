const CACHE='bali-cocktail-v8-category-alpha';
const CORE=['./','./index.html','./cocktails.json','./manifest.webmanifest','./images/ic_launcher.png','./ingredient-zoom.js','./readonly-mobile.js','./sort-alpha.js'];
