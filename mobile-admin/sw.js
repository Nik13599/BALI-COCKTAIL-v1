const CORE='bali-mobile-admin-core-v5-offline';
const MEDIA='bali-mobile-admin-media-v5';
const CORE_FILES=['./','./index.html','./admin-v3.html','./iphone-offline.html','./manifest.webmanifest','./admin-runtime-fix.js','./offline-first.js','./app-icon.png'];
...
self.addEventListener('fetch',e=>{
  ...
  if(u.hostname==='raw.githubusercontent.com'&&(u.pathname.includes('/media/')||u.pathname.includes('/images/'))){
