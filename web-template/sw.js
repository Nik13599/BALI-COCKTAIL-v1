const CACHE='bali-cocktail-v6-readonly';
const CORE=['./','./index.html','./cocktails.json','./manifest.webmanifest','./images/ic_launcher.jpg','./ingredient-zoom.js','./readonly-mobile.js'];
